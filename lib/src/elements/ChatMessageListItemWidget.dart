...
class ChatMessageListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (user != null) {
      // return user.uid == this.chat.userId
      print('======'+user.uid +'=='+ this.chat.fromUserId);
      return user.uid == this.chat.fromUserId
          ...
          children: [
            new Flexible(
              child: new Column(
                ...
                children: <Widget>[
                  new Text('You', style: Theme.of(context).textTheme.bodyText1.merge(TextStyle(fontWeight: FontWeight.w600))),
                  new Container(
          ...
          children: <Widget>[
            ...
            new Flexible(
              child: new Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  new Text(this.chat.fromUserName,
