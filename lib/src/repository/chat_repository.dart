...
import 'package:ezfastnow/src/models/chat.dart';
...
//  }
  ...
  Future<void> deleteMessage(Conversation conversation) {
    return FirebaseFirestore.instance.collection("conversations").doc(conversation.id).delete().catchError((e) {
      print(e.toString());
    });
  }
}
