...
//   print("=====user.toMap()==="+ user.toMap().toString());
//   final client = new http.Client();
//   final response = await client.post(
//     url,
//     headers: {HttpHeaders.contentTypeHeader: 'application/json'},
//     body: json.encode(user.toMap()),
//   );
//   print("=====profile body==="+ response.body.toString());
//   setCurrentUser(response.body);
//   currentUser.value = User.fromJSON(json.decode(response.body)['data']);
//   return currentUser.value;
// }
...
//   final client = new http.Client();
//   print("Url  $url Json ${json.encode(address.toMap())}");
//   final response = await client.post(
//     url,
//     headers: {HttpHeaders.contentTypeHeader: 'application/json'},
...
//     body: json.encode(address.toMap()),
//   );
//   print("====address.toMap()==="+address.toMap().toString());
//   print("====address.toMap()body==="+json.decode(response.body)['data'].toString());
//   return Address.fromJSON(json.decode(response.body)['data']);
// }
//
